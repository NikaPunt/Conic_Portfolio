...
μ_required = range(0,stop=0.36,length=100);
...
plot(vols(AssetArray).^2, means(AssetArray),seriestype=:scatter,xlabel="Volatility σ",ylabel="Return μ",label="Stocks",title="Efficient Frontier",legend=:bottomright)
