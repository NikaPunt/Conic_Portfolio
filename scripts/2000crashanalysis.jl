...
open("data/DJ2000/w_optimvar2000.txt", "w") do file
    write(file, string(w_optimvar))
end
open("data/DJ2000/w_optimvar2000_short.txt", "w") do file
    write(file, string(w_optimvar_short))
end
open("data/DJ2000/w_optimcvar95-2000.txt", "w") do file
    write(file, string(w_optimcvar95))
end
open("data/DJ2000/w_optimcvar95-2000_short.txt", "w") do file
    write(file, string(w_optimcvar95_short))
end
open("data/DJ2000/w_optimcvar99-2000.txt", "w") do file
    write(file, string(w_optimcvar99))
end
open("data/DJ2000/w_optimcvar99-2000_short.txt", "w") do file
    write(file, string(w_optimcvar99_short))
end
