...
open("data/DJ2008/w_optimvar2008.txt", "w") do file
    write(file, string(w_optimvar))
end
open("data/DJ2008/w_optimvar2008_short.txt", "w") do file
    write(file, string(w_optimvar_short))
end
open("data/DJ2008/w_optimcvar95-2008.txt", "w") do file
    write(file, string(w_optimcvar95))
end
open("data/DJ2008/w_optimcvar95-2008_short.txt", "w") do file
    write(file, string(w_optimcvar95_short))
end
open("data/DJ2008/w_optimcvar99-2008.txt", "w") do file
    write(file, string(w_optimcvar99))
end


open("data/DJ2008/w_optimcvar99-2008_short.txt", "w") do file
...
Threads.@threads for i = 8:10
    ...
    if i < 6
        ...
        open("data/w_optimgap$nummer-2008.txt", "w") do file
            write(file, string(five_γ[i]))
        end 
    else
        index = (i+1)%6
        print(index)
        nummer = a[index]
        five_γ_short[index] = getMinConicWeights(Rtrns,a[index],true)
        open("data/w_optimgap$nummer-2008_short.txt", "w") do file
            write(file, string(five_γ_short[i]))
        end 
    end 
end
